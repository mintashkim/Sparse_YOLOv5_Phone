...
//	BruteForce 접근방법을 이용하여 추정함
typedef struct _FILE_OLE_DIRECTORY_INFORMATION { // Information Class 37
	ULONG NextEntryOffset;
	ULONG Unknown;
	LARGE_INTEGER CreationTime;
	LARGE_INTEGER LastAccessTime;
	...
	ULONG Unknown2;
	WCHAR FileName[1];
} FILE_OLE_DIRECTORY_INFORMATION, *PFILE_OLE_DIRECTORY_INFORMATION;
...
typedef enum _PROCESSINFOCLASS {
	...
	ProcessRevokeFileHandles, // s: PROCESS_REVOKE
} PROCESSINFOCLASS;
